...
module.exports = {
  ...
  styles: {
    src:  [srcAssets + '/less/rem.less', srcAssets + '/less/sm*.less', srcAssets + '/less/xmdd.less'],
    filter:{
      rem: ['**', '!**/rem.css']
    },
  ...
  html: {
    ...
    production: {
      ...
      jsfilter: ['**', '!**/common*.js', '!**/weshare.js', '!**/app-abc.js', '!**/apply-index-bridge.js'],
      cssfilter: ['**/*.css'],
      cssUrlReplace: {
        regExps:[/..\/img\//],
        newPath: '../images/'
